...
//        String apiUrl = "https://remotesetu.in:4679/get-socket/" + deviceId;
        String apiUrl = RemoteCallback.getRemoteURL() + "/get-socket/" + deviceId; // Firebase
...
//                    BitMatrix bitMatrix = writer.encode("https://remotesetu.in:4679" + url, BarcodeFormat.QR_CODE, width, height);
                    BitMatrix bitMatrix = writer.encode(RemoteCallback.getRemoteURL() + url, BarcodeFormat.QR_CODE, width, height); // Firebase
